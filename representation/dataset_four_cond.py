...
import representation_fourtag_drum
import utils
import pandas as pd
import os
@utils.resolve_paths
...
class MusicDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # print(f"dataset load = {self.data_dir / name[2] / name[3]}")
        if self.use_csv:
        ...
        tag_path = self.tag_dir / name[2] / name[3]/f"{name}.json"
        # print(f"tag ptah = {tag_path}")
        ...
        seq = self.encode_fn(notes, self.encoding, self.indexer,tag_path) # encode
        # Encode the notes
...
def main():
    ...
    representation = representation_fourtag_drum
