...
class MusicDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.tags!=None: # check tag, avoid empty sequence
            ...
            seq = self.encode_fn(notes, self.encoding, self.indexer,self.tags,tag_list) # encode
            # Encode the notes
