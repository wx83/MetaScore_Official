...
class MusicDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.tags!=None: # genre label
            ...
            seq = self.encode_fn(notes, self.encoding, self.indexer) # repr_prog pass prefix
        ...
        if self.tags == None: # sanity check
            print(f"Error, need tags")
